...
brew install hub python3 go zsh yarn ctags cquery ruby tmux fpp sed extract_url task entr ripgrep httpie roswell coreutils ktlint wiremock-standalone tidy-html5 exa
